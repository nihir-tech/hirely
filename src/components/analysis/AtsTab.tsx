    ...
    <div className="space-y-8 animate-fade-in">
      <div className="flex items-center gap-6">
        ...
        <div className="text-sm max-w-md">
          <p className="font-medium text-fg-strong mb-1">What this means</p>
      ...
      {ats.positives.length > 0 && (
        <Card className="p-6">
          <h3 className="text-lg font-semibold text-fg-strong mb-4">ATS Positives</h3>
          <ul className="space-y-2">
            {ats.positives.map((p, i) => (
              <li key={i} className="flex items-start gap-2">
                ...
                <span className="text-sm text-fg-strong">{p}</span>
              </li>
            ))}
          </ul>
        </Card>
      ...
      {ats.concerns.length > 0 && (
        <Card className="p-6">
          <h3 className="text-lg font-semibold text-fg-strong mb-4">ATS Concerns</h3>
          <div className="space-y-4">
            {ats.concerns.map((c, i) => (
              <div key={i} className="p-4 rounded-xl bg-surface-subtle border border-line">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    <p className="text-sm text-fg-muted">
                      <strong className="text-fg-strong">Risk:</strong> {c.risk}
                    </p>
                    <p className="text-sm text-fg-muted">
                      <strong className="text-fg-strong">Recommendation:</strong> {c.recommendation}
                    </p>
                  </div>
                </div>
              </div>
